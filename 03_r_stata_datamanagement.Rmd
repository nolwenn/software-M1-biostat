...
In the example below, we merge with the sleep apnea data the results of a questionnaire on daily concentration level for each patient ([here](https://github.com/nolwenn/software-M1-biostat/DayConcentration.txt) to download).
